...
public class MF_CommanderManager : MonoBehaviour, MF_ISignInCompleteCheck
{
    ...
    private void addRemoveCommanderComponents()
    {
        ...
        switch (commanderInfo.CommanderType)
        {
            ...
            case MF_ECommanderType.Player2:
                ...
                gameObject.AddComponent<MF_CommanderAutoControl>();
        ...
        gameObject.AddComponent<MF_CommanderScriptComponentsLink>();
    }
    ...
    public void _ICompleteCheck_CentralCallBack_Check_Run_Complete(int centralKey)
    {
        ...
        MF_SignInCompleteCheckCentral._ICompleteCheck_WaitForComplete(GetComponent<MF_CommanderInfo>()
