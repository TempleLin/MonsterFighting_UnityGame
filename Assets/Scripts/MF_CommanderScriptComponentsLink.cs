...
public class MF_CommanderScriptComponentsLink : MonoBehaviour, MF_IStartByManager
{
    ...
    [SerializeField] public MF_CommanderAutoControl commanderAutoControl;
    ...
    public MF_CommanderAutoControl CommanderAutoControl => commanderAutoControl;
    ...
    public void startByManager()
    {
        ...
        commanderAutoControl = GetComponent<MF_CommanderAutoControl>();
